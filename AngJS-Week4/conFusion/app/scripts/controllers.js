...
angular.module('confusionApp')
        ...
        .controller('DishCommentController', ['$scope','menuFactory', function($scope,menuFactory) {
            ...
            $scope.mycomments =angular.copy($scope.newComment);
            $scope.submitComment = function () {
                
                $scope.mycomments.date = new Date().toISOString();
                console.log($scope.mycomments);
                
                $scope.dish.comments.push($scope.mycomments);
        ...
        // implement the IndexController and About Controller here
         ...
         .controller('IndexController', ['$scope','menuFactory','corporateFactory', function($scope,menuFactory,corporateFactory) {
             ...
             $scope.message="Loading..."; $scope.feautureDish=menuFactory.getDishes().get({id:0}).$promise.
             then(function(response){
                 $scope.feautureDish=response;
                 $scope.showDish =true;
             },
             function(response){
                        $scope.message="Error :"+response.status +" " + response.statusText; 
                    });
             $scope.promotion=menuFactory.getPromotion().get({id:0}).$promise.
             then(
                 function(response){
